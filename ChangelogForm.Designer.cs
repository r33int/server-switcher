namespace AkatsukiServerSwitcher
{
    partial class ChangelogForm
    {
        ...
        bloom15};
            ...
            this.textBox1.Text = "Welcome to Kawata server switcher! To play on Kawata, all you have to do is install the certificate, and switch to Kawata server. When you're done, go back here to switch back to official osu! server. Happy hacking!";
